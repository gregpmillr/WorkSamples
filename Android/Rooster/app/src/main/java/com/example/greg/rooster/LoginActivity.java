...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action)
                {
                    case RoosterConnectionService.UI_AUTHENTICATED:
                        Log.d("Broadcasting","Got a broadcast to show the main app window");
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Log.d("Proceeding", "Jid and password are valid, proceeding with login.");
    ...
    {
        Log.d("SaveCredsLogin","saveCredentialsAndLogin() called.");
