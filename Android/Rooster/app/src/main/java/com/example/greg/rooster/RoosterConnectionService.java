...
public class RoosterConnectionService extends Service {
    ...
    public static final String UI_AUTHENTICATED = "com.example.greg.rooster.uiauthenticated";
    public static final String SEND_MESSAGE = "com.example.greg.rooster.sendmessage";
    public static final String BUNDLE_MESSAGE_BODY = "b_body";
    public static final String BUNDLE_TO = "b_to";
    public static final String NEW_MESSAGE = "com.example.greg.rooster.newmessage";
    ...
    //called from intent in LoginActivity
    @Override
